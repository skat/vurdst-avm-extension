...
ejendomssalg_pcl <- ejendomssalg %>%
                    filter(bygning.bygningsanvendelse %in% c(120,121,122,130,131,132),
                           ...
                           is.na(deljordstykke.plandata_plandata.udstykstoerrelse) | deljordstykke.plandata_plandata.udstykstoerrelse >= 400 & deljordstykke.plandata_plandata.udstykstoerrelse <= 1000,
                           is.na(deljordstykke.plandata_plandata.maksbebygpct) | deljordstykke.plandata_plandata.maksbebygpct >= 20 & deljordstykke.plandata_plandata.maksbebygpct <= 50,
