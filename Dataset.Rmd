...
#Berig delgrunde med plandata for deljordstykker. Der anvendes kun delgrund med ét deljordstykke per delgrund

#grundsalg <- grundsalg %>% filter(delgrund.deljordstykker_per_delgrund == 1) 
...
#Dan rest- og etageareal. Grunde med vejarealer er frasorteret, saa det gaar godt at anvende vurinfo.registreretareal_fratrukket_vejareal
grundsalg_pcl <- grundsalg_pcl %>%  mutate(etageareal = vurinfo.registreretareal_fratrukket_vejareal * deljordstykke.plandata_plandata.maksbebygpct / 100,
