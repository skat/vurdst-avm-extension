...
wrap_plots(plots_spatial_combined, ncol = 3)
...
smooth_variables <- c(standard_property_value_Model1 = "Standard property value",
                      standard_property_value_Model2 = "Standard property value",
                      standard_property_value_Model3 = "Standard property value",
                      standard_property_value_Model4 = "Standard property value",
                      sales_date_numeric = "Sales date",
                      year_built = "Year built",
                      year_rebuilt = "Year rebuilt",
                      living_space = "Living space [m²]",
...
make_smooth_plots <- function(models, model_set_name, smooth_variables) {
  ...
  for (var in names(smooth_variables)) {
    ...
    plot_title <- paste0(model_set_name, ": ", smooth_variables[[var]])
