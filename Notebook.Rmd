...
The code below extracts and plots the remaining smooth effects of the trained GAM-models. A smooth corresponding to each trained model is plotted, but for readability confidence intervals are only displayed for Model1. 
...
#### Factor effects
The code below extracts and plots the factor effects of trained GAM-models. A point is shown for the effect of each model but error bars are shown only for Model1. 
...
plot_test_residuals <- ggplot(residual_df_test, 
                       ...
                       scale_linetype_manual(name = NULL,
                                             ...
                                             guide = guide_legend(override.aes = list(color = "black", size = 0.8), 
                                                                  ...
                                                                  byrow = TRUE)) +
                       ylim(-3, 3) +
                       labs(x = "Sales Price [million kr.]", y = "Residuals [million kr.]", color = "Municipality Type") +
...
```{r Interpretation, eval=TRUE, echo=TRUE, warning=FALSE, results = 'hide'}
...
plot_uncertainties <- ggplot(test_set, aes(x = se_Model1, 
                      ...
                      scale_color_viridis_c(option = "plasma", trans = "log1p", name = "Sales Price [million kr.]") +
